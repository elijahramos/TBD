...
def norm(filePath):
	...
	mKey = kg.private_bytes(encoding=serialization.Encoding.PEM,format=serialization.PrivateFormat.PKCS8,encryption_algorithm=serialization.NoEncryption())
	
	fileString = fileObj.read()
	key = os.urandom(cnsts.keyLength) #Generate a 32 byte key
	fileEncrypt = MyencryptMAC.norm(fileString, key, mKey) #Store the cipher and IV generated by Myencrypt.norm
	...
	return [C, IV, key,location,cutFile[0],cutFile[2],tag,mKey] #Return C, IV, key,fileDir,fileName,fileExt,tag,HMACKey
